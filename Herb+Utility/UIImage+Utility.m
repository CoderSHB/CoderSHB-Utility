...
+ (UIImage *)imageMarkWithBackgroundImageName:(NSString *)bgName
                                markImageName:(NSString *)markImageName
                                 markPosition:(CGPoint)markPosition {
...
+ (UIImage *)imageMarkWithBackgroundImageName:(NSString *)bgName
                                markImageName:(NSString *)markImageName
                                 markPosition:(ImageMarkPosition)markPosition
